...
mysql_username = 'YOURMYSQLUSERNAME'  # please change to your username
mysql_password = 'YOURMYSQLPASS'  # please change to your MySQL password
...
try:
    ...
    values = str(next_id) + ",'" + name + "','" + supplier_id + \
        "','" + quantity + "','" + unit_price + "'"
